...
<body bgcolor=#000000>
  ...
  <div class="bgimg">
    ...
    <div class="caption"><br><br>
      ...
      <div>
        <div class="button">
          <font size=7 style="letter-spacing: 10px;"><b>GIRISH GUPTA</b></font>
        </div>
      </div>
      ...
      <div class="text">
        ...
        I live in San Francisco and am a founding software engineer at <a href="https://www.subcity.com"><i>Subcity</i></a>, a well-run, mission-driven startup where we help small businesses tap into government subsidies that all too often go unclaimed.
        <br><br>
        Previously, I've founded a company, <a href="https://www.datadrum.com"><i>Data Drum</i></a>, built many products from scratch, headed a data science unit, and led tech at a news/machine learning startup.
        <br><br>
        I also have extensive experience in international journalism. My deep investigative and multimedia reporting from Caracas, where I was based for just under a decade, to Kabul, has been published by everyone from the <i>New Yorker</i> to <i>Reuters</i>, where I was a Senior Correspondent.
        <br><br>
        My book, <a href="https://www.alwaysgo.xyz"><i>Always Go</i></a>, is my honest memoir about my time as a reporter.
        <br><br>
        My deepest passion, though, is physics, which I studied—to Master's level—at Cambridge and Manchester. Ultimately, physics and journalism are both built upon curiosity and attempt to explain the world through observation and logic, without bias or bowing to authority.
        <br><br>
        Please get in touch if you're keen to chat. I'm always open to meeting enthusiastic and interesting new people. (And definitely get in touch if you want to get into journalism and aren't from a traditional background. I'd love to help!)
        <br><br>
      </div>
      ...
      <div>
        <div class="button"><a href="mailto:girish@girishgupta.com">Email Me</a></div>
      </div>
      ...
      <div class="text">
        ...
        <br><br>
        I then spent just over a year in Mumbai where I built a data science unit at a public policy <a href="https://www.idfcinstitute.org">non-profit</a>. Over the years, I've created smaller-scale products of my own—<a href="https://www.globalotp.com">GlobalOTP</a>, <a href="https://www.readwise2roam.com">Readwise2Roam</a>, <a href="https://www.accordingtodocuments.com">According To Documents</a> and <a href="https://apps.apple.com/us/app/math-for-journalists/id1547221444">Math for Journalists</a>. Then, as Chief Technology Officer at Stanford-conceived, Google-funded startup <a href="https://www.deepnews.ai">Deepnews</a>, I helped build a machine learning algorithm to identify quality journalism at scale.
        <br><br>
        In 2021, I moved to San Francisco and spent eight months writing a memoir, <a href="https://www.alwaysgo.xyz"><i>Always Go</i></a> about my time as a reporter. Late 2021, I joined <a href="https://www.subcity.com"><i>Subcity</i></a>.
      ...
      <div>
        <div class="button"><a href="https://www.subcity.com/">Subcity</a></div>
      </div>
      <div>
        <div class="button"><a href="https://www.datadrum.com/">Data Drum</a></div>
      </div>
      <div>
        <div class="button"><a href="https://www.accordingtodocuments.com/">According to Documents</a></div>
      </div>
      <div>
        <div class="button"><a href="https://www.globalotp.com/">GlobalOTP</a></div>
      </div>
      <div>
        <div class="button"><a href="https://www.mathforjournalists.com/">Math for Journalists</a></div>
      </div>
      <div>
        <div class="button"><a href="https://www.readwise2roam.com/">Readwise2Roam</a></div>
      </div>
      <!-- <div><div class="button"><a href="https://www.freelanceforeigncorrespondent.com/">Freelance Foreign Correspondent</a></div></div> -->
      <div>
        <div class="button"><a href="https://www.musicgoeson.com/">Music Goes On</a></div>
      </div>
      <div>
        <div class="button"><a href="https://storage.googleapis.com/girishnet/index.htm">First Website</a></div>
      </div>

      <br><br>

      <div>
        <div class="button"><a href="https://www.girishgupta.com/CV.pdf">CV</a></div>
      </div>
      ...
      <div>
        <div class="text">
          <font size=2>Photo: Oil wells set ablaze by Islamic State before fleeing Qayyara, Iraq. January, 2017.</font>
        </div>
      </div>
